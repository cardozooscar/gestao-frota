              ...
              <div className={`flex items-center ${collapsed ? 'justify-center' : 'gap-3'}`}>
                ...
                {!collapsed && (
                  <div className="min-w-0">
                    <p className="text-[11px] uppercase tracking-[0.28em] text-slate-400">Fibranet Brasil</p>
            ...
            {!collapsed && (
              <div className="shrink-0 border-b border-white/10 px-4 py-4">
                <div className="rounded-xl bg-white/5 p-4 ring-1 ring-white/10">
                  <p className="text-xs uppercase tracking-wide text-slate-400">Usuário conectado</p>
                  <p className="mt-2 text-base font-semibold text-white">{profile?.nome}</p>
