...
export default function RecibosEPIPage() {
  ...
  // Função nativa para formatar data sem precisar de bibliotecas extras
  ...
  if (loading) {
    return (
      <div className="p-8 flex justify-center">
        <p className="text-slate-500 animate-pulse">Sincronizando recibos da Fibranet...</p>
      </div>
    )
  }
  ...
  return (
    <div className="p-4 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {recibos.length === 0 ? (
          <p className="text-slate-400 text-sm italic">Nenhum recibo encontrado no banco.</p>
        ) : (
          recibos.map((recibo) => (
            <div 
              key={recibo.id}
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-slate-500 text-sm">
                  ...
                  {formatarData(recibo.created_at)}
                </div>
              </div>
            ...
            <div className="p-6 max-h-[80vh] overflow-y-auto">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="text-left text-slate-500 border-b border-slate-200">
                        ...
                        <th className="pb-2 text-right font-bold">Tam</th>
                      </tr>
                    </thead>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="aspect-square rounded-xl bg-slate-100 border border-slate-200 overflow-hidden">
                    <img 
                      ...
                      onError={(e) => (e.currentTarget.src = 'https://via.placeholder.com/400?text=Imagem+Nao+Encontrada')}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="aspect-square md:aspect-auto md:h-[calc(100%-1.5rem)] rounded-xl bg-white border border-slate-200 flex items-center justify-center p-4">
                    <img 
                      src={selectedRecibo.signature_url} 
                      alt="Assinatura" 
                      className="max-w-full max-h-full object-contain"
                      onError={(e) => (e.currentTarget.src = 'https://via.placeholder.com/400x200?text=Erro+na+Assinatura')}
                    />
                  </div>
                </div>
              </div>
